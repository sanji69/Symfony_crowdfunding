...
class AppFixtures extends AbstractFixture
{
     ...
     * Articles Fixtures
     */
    public function loadArt(ObjectManager $manager)
    {
    ...
    {
        return [
            // $userData = [$title, $content, $goal, $status, $actived, $user];
     ...
     */
    public function loadContrib(ObjectManager $manager)
    {

        // chargement contributions
        foreach ($this->getContribData() as [$users, $articles, $value]) {
    ...
    private function getContribData(): array
    {
        return [
